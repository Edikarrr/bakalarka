...
%popis tematu
%zduvodneni tematu
%proc je tema aktualni
%vytyceni hlavniho cile prace + rozclenit ho na dilci kroky
%vytyčení pracovních hypotéz
%co si myslí a jaký má názor na zvolenou problematiku
%
...
\komentar{ klicova slova: forenzni audit, unik penez, prosetreni spolecnosti, vyhledavani dukazu, pocitacova podpora, aplikace podporujici forenzni audit, vizualizace procesu vysetrovani, report o vysetrovanem pripadu, metodika forenzniho auditu, navrh informacniho systemu, digital forensics ... }
